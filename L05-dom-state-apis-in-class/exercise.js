...
/* =========================================================
   L05 — DOM • State • Browser APIs (Complete Implementation)
   Rules:
...
// Call updateListStats() once on page load
updateListStats();
...
/* =========================================================
   ...
   Data model: cartState.items = array of { name, price }
   Derived UI:
   - Items count
   - Total price
   TODO:
...
// Optional: renderNote(localStorage.getItem(NOTE_KEY)) on page load
